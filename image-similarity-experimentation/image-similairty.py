...
class Tracker:
    ...
    def calculate_image_similarity_feature(self, image1, image2):
      ...
      Returns:
        A float between 0 and 1, where 0 means the images are not similar and 1 means the images are identical.
      ...
      # Calculate the SIFT features for each image.
      ...
      if similarity_score > 0.5: return 1
      return 0
